...
export const ARCHITECTURE_REVIEW_PIPELINE_PHASES: PhaseDefinition[] = [
  ...
  { number: 6,  name: 'Spec Validation',           type: 'conversation', agentId: 'arch-spec-validator',                abbreviation: 'Val',    stage: 4, stageName: 'Spec',      resetable: false },
  { number: 7,  name: 'Spec Enricher',             type: 'conversation', agentId: 'architecture-spec-enricher',         abbreviation: 'Enrich', stage: 4, stageName: 'Spec',      resetable: false },
...
export const DEVELOPMENT_V2_PIPELINE_PHASES: PhaseDefinition[] = [
  { number: 1,  name: 'Discovery',            type: 'conversation', agentId: 'discovery-agent',   abbreviation: 'Disc',   stage: 1, stageName: 'Discovery',  resetable: true  },
  { number: 2,  name: 'User Stories',         type: 'auto',         agentId: 'prd-generator',     abbreviation: 'Story',  stage: 2, stageName: 'PRD',        resetable: true  },
  { number: 3,  name: 'PRD Validator',        type: 'conversation', agentId: 'prd-validator',     abbreviation: 'Val',    stage: 2, stageName: 'PRD',        resetable: false },
  { number: 4,  name: 'Design Plan',          type: 'auto',         agentId: 'design-plan',        abbreviation: 'DPlan', stage: 3, stageName: 'Design',     resetable: true  },
  { number: 5,  name: 'LionDesign Studio',    type: 'conversation', agentId: 'open-design-studio',abbreviation: 'LDS',    stage: 3, stageName: 'Design',     resetable: true  },
  { number: 6,  name: 'Design Lock',          type: 'auto',         agentId: 'design-lock',       abbreviation: 'Lock',   stage: 3, stageName: 'Design',     resetable: false },
  { number: 7,  name: 'PRD Completo',         type: 'auto',         agentId: 'pipe2-prd-completo',abbreviation: 'PRD+',   stage: 4, stageName: 'PRD+',       resetable: true  },
  { number: 8,  name: 'Database',             type: 'conversation', agentId: 'tech-database',     abbreviation: 'DB',     stage: 5, stageName: 'Tech',       groupId: 'tech', groupLabel: 'TECH', resetable: false },
  { number: 9,  name: 'Backend',              type: 'conversation', agentId: 'tech-backend',      abbreviation: 'BE',     stage: 5, stageName: 'Tech',       groupId: 'tech', groupLabel: 'TECH', resetable: false },
  { number: 10, name: 'Frontend Tecnico',     type: 'conversation', agentId: 'pipe2-tech-frontend',abbreviation: 'FE',    stage: 5, stageName: 'Tech',       groupId: 'tech', groupLabel: 'TECH', resetable: false },
  { number: 11, name: 'Security',             type: 'conversation', agentId: 'tech-security',     abbreviation: 'SEC',    stage: 5, stageName: 'Tech',       groupId: 'tech', groupLabel: 'TECH', resetable: false },
  { number: 12, name: 'Spec Generation',      type: 'auto',         agentId: 'pipe2-spec-builder',abbreviation: 'Spec',   stage: 6, stageName: 'Spec',       resetable: true  },
  { number: 13, name: 'Spec Enricher',        type: 'conversation', agentId: 'pipe2-spec-enricher',abbreviation: 'Enrich',stage: 6, stageName: 'Spec',       resetable: false },
  { number: 14, name: 'Planner',              type: 'auto',         agentId: 'harness-planner',   abbreviation: 'Plan',   stage: 7, stageName: 'Execution',  resetable: true  },
  { number: 15, name: 'Sprint Validator',     type: 'conversation', agentId: 'sprint-validator',  abbreviation: 'SVal',   stage: 7, stageName: 'Execution',  resetable: true  },
  { number: 16, name: 'Coder',                type: 'loop',         agentId: 'harness-coder',     abbreviation: 'Code',   stage: 7, stageName: 'Execution',  resetable: false },
  { number: 17, name: 'Evaluator',            type: 'loop',         agentId: 'harness-evaluator', abbreviation: 'Eval',    stage: 7, stageName: 'Execution',  resetable: false },
];


export const BUG_PIPELINE_PHASES: PhaseDefinition[] = [
  { number: 1, name: 'Bug Discovery',    type: 'conversation', agentId: 'bug-discovery',             abbreviation: 'Bug',     stage: 1, stageName: 'Diagnostico', resetable: true  },
  { number: 2, name: 'Analise Paralela', type: 'auto',         agentId: 'bug-analysis-multi',        abbreviation: 'Analise', stage: 2, stageName: 'Analise',     resetable: true  },
  { number: 3, name: 'Consolidacao',     type: 'conversation', agentId: 'bug-solution-consolidator', abbreviation: 'Plano',   stage: 2, stageName: 'Analise',     resetable: true  },
  { number: 4, name: 'Spec Generation',  type: 'auto',         agentId: 'spec-builder',              abbreviation: 'Spec',    stage: 3, stageName: 'Spec',        resetable: true  },
  { number: 5, name: 'Spec Validator',   type: 'conversation', agentId: 'bug-spec-validator',        abbreviation: 'Val',     stage: 3, stageName: 'Spec',        resetable: false },
  { number: 6, name: 'Planner',          type: 'auto',         agentId: 'harness-planner',           abbreviation: 'Plan',    stage: 4, stageName: 'Execution',   resetable: true  },
  { number: 7, name: 'Sprint Validator', type: 'conversation', agentId: 'sprint-validator',          abbreviation: 'SVal',    stage: 4, stageName: 'Execution',   resetable: true  },
  { number: 8, name: 'Coder',            type: 'loop',         agentId: 'harness-coder',             abbreviation: 'Code',    stage: 4, stageName: 'Execution',   resetable: false },
  { number: 9, name: 'Evaluator',        type: 'loop',         agentId: 'harness-evaluator',         abbreviation: 'Eval',    stage: 4, stageName: 'Execution',   resetable: false },
];
...
export function conversationPhasesOf(type: string | undefined): Set<number> {
  ...
  const result = new Set<number>(
    phases.filter((p) => !auto.has(p.number) && !loop.has(p.number)).map((p) => p.number),
  );
...
export function loopPhasesByRoleWithHistoryOf(
