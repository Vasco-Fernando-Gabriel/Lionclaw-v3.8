  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 px-3.5 py-2.5 border-b border-zinc-800 shrink-0">
        <span className="w-2 h-2 rounded-full" style={{ backgroundColor: COLUMN_DOTS[column] }} />
        <span className={`text-[13px] font-semibold ${isOver ? 'text-amber-500' : 'text-zinc-200'}`}>{column}</span>
