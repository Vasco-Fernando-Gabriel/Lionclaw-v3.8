...
<html lang="en">
  <head>
    ...
    <title>${connectorLabelHtml} connected · LionDesign</title>
    <style>
      :root {
        --bg: #faf9f7;
        --bg-panel: #ffffff;
  ...
  <body>
    <main aria-labelledby="callback-title">
      <div class="chrome" aria-label="LionDesign">
        <span class="brand-mark" aria-hidden="true">OD</span>
        <span class="brand-title">LionDesign</span>
      </div>
      <section class="content">
        ...
        <div>
          ...
          <p>Your connector is ready to use in LionDesign.</p>
        </div>
    ...
    <script>
      (() => {
        ...
        function showManualCloseHint() {
          ...
          hint.textContent = 'Your browser blocked automatic closing. You can close this tab and return to LionDesign.';
        }
        ...
        try {
          if (hasLiveOpener()) {
            ...
            hint.textContent = 'You can close this tab and return to LionDesign.';
          }
        } catch {
          hint.textContent = 'You can close this tab and return to LionDesign.';
        }
