...
export const tr: Dict = {
  ...
  'settings.welcomeTitle': 'LionDesign kurulumu',
  ...
  'settings.agentInstall.pathHint':
    'Bir CLI\'yi npm veya Homebrew ile kurduysan ancak hâlâ kurulu değil olarak görünüyorsa, aracın bin dizininin LionDesign daemon\'unun devraldığı PATH içinde olduğundan emin ol (macOS\'te Terminal ve GUI uygulamalarının PATH\'i farklı olabilir). QUICKSTART.md içindeki "Local agent CLI and PATH" bölümüne bak.',
  'settings.agentInstall.stepOpenLinks': 'Tercih ettiğin ajan için Yükle veya Dokümanlar bağlantısını aç.',
  'settings.agentInstall.stepAuth':
    'LionDesign\'a dönmeden önce sağlayıcı CLI\'sinde kimlik doğrulaması yap (oturum aç veya API kimlik bilgileri ekle).',
  ...
  'settings.mcpServerHint': 'LionDesign\'ı kodlama ajanınız için MCP sunucusu olarak yayınlayın.',
  ...
  'preview.errorBody': 'Örnek HTML\'i alınamadı. LionDesign\'ın çalıştığından emin olup tekrar deneyin.',
  ...
  'pet.tabBuiltInHint': 'LionDesign ile gelen seçili dostlar — birini seç ve sahiplen.',
  ...
  'pet.codexBundledTitle': 'LionDesign ile birlikte gelir — indirme gerekmez.',
