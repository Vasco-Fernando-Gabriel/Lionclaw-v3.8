...
export const de: Dict = {
  ...
  'settings.welcomeTitle': 'LionDesign einrichten',
  ...
  'settings.agentInstall.stepAuth':
    'Authentifizieren Sie sich mit der Anbieter-CLI (anmelden oder API-Zugangsdaten setzen), bevor Sie zu LionDesign zurueckkehren.',
  ...
  'settings.mcpServerHint': 'Stelle LionDesign als MCP-Server für deinen Coding-Agent bereit.',
  ...
  'preview.errorBody': 'Das Beispiel-HTML konnte nicht abgerufen werden. Stelle sicher, dass LionDesign läuft, und versuche es erneut.',
  ...
  'pet.tabBuiltInHint': 'Mit LionDesign gebündelte Begleiter — auswählen und adoptieren.',
  ...
  'pet.codexBundledTitle': 'Wird mit LionDesign ausgeliefert — kein Download nötig.',
