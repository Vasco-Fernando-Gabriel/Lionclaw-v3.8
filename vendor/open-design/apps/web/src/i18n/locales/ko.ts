...
export const ko: Dict = {
  ...
  'settings.welcomeTitle': 'LionDesign 설정',
  ...
  'settings.agentInstall.pathHint':
    'npm 또는 Homebrew로 CLI를 설치했는데도 아직 미설치로 표시된다면, LionDesign daemon이 상속받는 PATH에 도구의 bin 디렉터리가 포함되어 있는지 확인하세요(macOS에서는 Terminal과 GUI 앱의 PATH가 다를 수 있습니다). QUICKSTART.md("Local agent CLI and PATH" 섹션)를 참고하세요.',
  'settings.agentInstall.stepOpenLinks': '원하는 에이전트 카드에서 설치 또는 문서 링크를 여세요.',
  'settings.agentInstall.stepAuth':
    'LionDesign으로 돌아오기 전에 공급자 CLI에서 인증(로그인 또는 API 자격 증명 추가)을 완료하세요.',
  ...
  'settings.mcpServerHint': 'LionDesign을 코딩 에이전트용 MCP 서버로 노출합니다.',
  ...
  'preview.errorBody': '예제 HTML을 가져오지 못했습니다. LionDesign이 실행 중인지 확인하고 다시 시도하세요.',
  'preview.retry': '다시 시도',
  ...
  'pet.title': '펫',
  'pet.tabBuiltIn': '내장',
  'pet.tabBuiltInHint': 'LionDesign에 기본 포함된 친구들 — 골라서 입양하세요.',
  ...
  'pet.codexBundled': '내장',
  'pet.codexBundledTitle': 'LionDesign 에 내장 — 다운로드 불필요.',
