...
export const pl: Dict = {
  ...
  'settings.welcomeTitle': 'Skonfiguruj LionDesign',
  ...
  'settings.agentInstall.pathHint':
    'Jeśli zainstalowano CLI przez npm lub Homebrew, ale nadal widnieje jako niezainstalowana, upewnij się, że katalog bin narzędzia jest w PATH dziedziczonym przez daemon LionDesign (na macOS PATH w Terminalu i aplikacjach GUI może się różnić). Zobacz QUICKSTART.md (sekcja "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Otwórz Zainstaluj lub Dokumentacja dla wybranego agenta.',
  'settings.agentInstall.stepAuth':
    'Uwierzytelnij się w CLI dostawcy (zaloguj się lub dodaj dane API), zanim wrócisz do LionDesign.',
  ...
  'settings.mcpServerHint': 'Udostępnij LionDesign jako serwer MCP dla swojego agenta kodu.',
  ...
  'preview.errorBody': 'Nie udało się pobrać kodu HTML przykładu. Upewnij się, że LionDesign jest uruchomiony, i spróbuj ponownie.',
  ...
  'pet.tabBuiltInHint': 'Towarzysze dołączeni do LionDesign — wybierz jednego i adoptuj.',
  ...
  'pet.codexBundledTitle': 'Dostarczany z LionDesign — bez pobierania.',
