...
export const fa: Dict = {
  ...
  'settings.welcomeTitle': 'LionDesign را راه‌اندازی کنید',
  ...
  'settings.agentInstall.stepAuth':
    'قبل از بازگشت به LionDesign، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.mcpServerHint': 'LionDesign را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید LionDesign در حال اجراست و دوباره تلاش کنید.',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه LionDesign — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه LionDesign ارائه می‌شود — نیازی به دانلود نیست.',
