...
export const ru: Dict = {
  ...
  'settings.welcomeTitle': 'Настройте LionDesign',
  ...
  'settings.agentInstall.pathHint':
    'Если вы установили CLI через npm или Homebrew, но она всё ещё отмечена как не установленная, убедитесь, что bin-каталог инструмента есть в PATH, который наследует daemon LionDesign (в macOS PATH у Terminal и GUI-приложений может отличаться). См. QUICKSTART.md (раздел "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Откройте Установить или Документация для нужного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдите аутентификацию в CLI поставщика (вход или добавление API-ключей), затем вернитесь в LionDesign.',
  ...
  'settings.mcpServerHint': 'Откройте LionDesign как MCP-сервер для вашего кодинг-агента.',
  ...
  'preview.errorBody': 'Не удалось получить HTML примера. Убедитесь, что LionDesign запущен, и повторите попытку.',
  ...
  'pet.tabBuiltInHint': 'Подобранные питомцы в комплекте LionDesign — выберите и забирайте.',
  ...
  'pet.codexBundledTitle': 'Поставляется с LionDesign — загрузка не нужна.',
