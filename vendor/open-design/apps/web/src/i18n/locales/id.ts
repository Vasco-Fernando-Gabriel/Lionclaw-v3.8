...
export const id: Dict = {
  ...
  'settings.welcomeTitle': 'Siapkan LionDesign',
  ...
  'settings.agentInstall.pathHint':
    'Jika Anda memasang CLI dengan npm atau Homebrew tetapi masih tampil sebagai belum terpasang, pastikan direktori bin alat ada di PATH yang diwarisi daemon LionDesign (PATH Terminal dan aplikasi GUI bisa berbeda di macOS). Lihat QUICKSTART.md (bagian "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Buka Instal atau Dokumentasi untuk agen pilihan Anda.',
  'settings.agentInstall.stepAuth':
    'Lakukan autentikasi di CLI vendor (masuk atau tambahkan kredensial API) sebelum kembali ke LionDesign.',
  ...
  'settings.mcpServerHint': 'Ekspos LionDesign sebagai server MCP untuk agen koding Anda.',
  ...
  'preview.errorBody': 'Pengambilan HTML contoh gagal. Pastikan LionDesign berjalan, lalu coba lagi.',
  ...
  'pet.tabBuiltInHint': 'Pet pilihan yang disertakan dengan LionDesign - pilih satu lalu adopsi.',
  ...
  'pet.codexBundledTitle': 'Disertakan dengan LionDesign - tidak perlu diunduh.',
