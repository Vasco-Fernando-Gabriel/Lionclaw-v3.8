...
repackaged as an LionDesign `deck` skill.
...
Follow LionDesign's deck export path for the active session (HTML / PDF /
PPTX per daemon capabilities).

## Relationship to LionDesign financial skills
...
original adaptation for LionDesign.
