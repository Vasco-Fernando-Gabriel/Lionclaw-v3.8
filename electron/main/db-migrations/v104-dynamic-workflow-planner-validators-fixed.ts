...
const NEW_BLOCK = `   - Use SOMENTE agentes ATIVOS no catalogo fornecido na execucao
   - Sem especialista adequado, use o coder generico fornecido
...
const NEW_MARKER = 'A stack escolhe SO o CODER';

export function applyMigrationV104(db: Database.Database): void {
  db.prepare(
