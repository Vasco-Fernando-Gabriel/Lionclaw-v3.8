...
const DIRECT_MCP_HELPER_SET: ReadonlySet<string> = new Set(
  DIRECT_MCP_HELPERS.map((id) => id.toLowerCase()),
);

export const TOOL_SCRIPT_HELPER_ID = 'lionclaw-toolscript';

export const CHAT_TURN_SCOPED_MCP_HELPERS: ReadonlySet<string> = new Set([
...
export const PROMPT_CATALOG_MCP_HELPERS: ReadonlySet<string> = new Set([
  TOOL_SCRIPT_HELPER_ID,
]);
