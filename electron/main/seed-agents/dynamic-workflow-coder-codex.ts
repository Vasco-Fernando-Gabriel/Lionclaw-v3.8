...
export const DYNAMIC_WORKFLOW_CODER_CODEX_ID = 'dynamic-workflow-coder-codex';

export const dynamicWorkflowCoderCodex: Omit<AgentConfig, 'sortOrder'> = {
  id: DYNAMIC_WORKFLOW_CODER_CODEX_ID,
