...
export const DYNAMIC_WORKFLOW_PLAN_VALIDATOR_COVERAGE_ID = 'dynamic-workflow-plan-validator-coverage';

export const dynamicWorkflowPlanValidatorCoverage: Omit<AgentConfig, 'sortOrder'> = {
