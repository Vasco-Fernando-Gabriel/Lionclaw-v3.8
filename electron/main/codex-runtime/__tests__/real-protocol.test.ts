...
const REAL_EVENTS: AppServerEvent[] = [
  ...
  { method: 'turn/started', params: { threadId: THREAD, turn: { id: TURN, status: 'inProgress' } } },
  {
    method: 'item/started',
    params: {
      item: { type: 'userMessage', id: 'u1', content: [{ type: 'text', text: 'Reply with exactly one word: pong' }] },
      threadId: THREAD,
      turnId: TURN,
    },
  },
  ...
  {
    method: 'item/started',
    params: { item: { type: 'reasoning', id: 'rs1', summary: [], content: [] }, threadId: THREAD, turnId: TURN },
  },
  { method: 'item/completed', params: { item: { type: 'reasoning', id: 'rs1' }, threadId: THREAD, turnId: TURN } },
  {
    method: 'item/started',
    params: {
      item: { type: 'agentMessage', id: 'msg1', text: '', phase: 'final_answer' },
      threadId: THREAD,
      turnId: TURN,
    },
  },
  { method: 'item/agentMessage/delta', params: { threadId: THREAD, turnId: TURN, itemId: 'msg1', delta: 'pong' } },
  {
    ...
    params: {
      item: { type: 'agentMessage', id: 'msg1', text: 'pong', phase: 'final_answer' },
      threadId: THREAD,
      turnId: TURN,
    },
  },
